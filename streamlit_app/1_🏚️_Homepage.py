...
df_clients_target = pd.read_csv(path+"/dataset_target_streamlit_compressed.gz", compression='gzip', sep=',')
...
def plot_gender(data: dict):
    ...
    image1 = Image.open(path+"/images/woman.png")
    image2 = Image.open(path+"/images/man.png")
...
def plot_house(data: dict):
    ...
    image1 = Image.open(path+"/images/house.png")
    image2 = Image.open(path+"/images/rent.png")
...
def plot_car(data: dict):
    ...
    image1 = Image.open(path+"/images/car.png")
    image2 = Image.open(path+"/images/walk.png")
...
def plot_working(data: dict):
    ...
    image1 = Image.open(path+"/images/working.png")
    image2 = Image.open(path+"/images/unemployment.png")
...
def plot_married(data: dict):
    ...
    image1 = Image.open(path+"/images/rings.png")
    image2 = Image.open(path+"/images/single.png")
...
def plot_children(data: dict):
    ...
    image1 = Image.open(path+"/images/father-and-son.png")
    image2 = Image.open(path+"/images/parents.png")
...
with tab2:
    ...
    st.markdown("Below you can see statistics on some of our current clients.") 
