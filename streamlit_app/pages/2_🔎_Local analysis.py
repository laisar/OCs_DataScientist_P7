...
with tab1:
    ...
    with mygrid[0][0]:
        ...
        with mygrid2[0][2]:
            ...
            if((data.loc[data[str(selected_client)] == "Gender", "Client information"] == "Woman").any()):             
                my_file = path2+'/images/woman.png'
                image = Image.open(my_file)
                st.image(image, use_column_width=False, caption='Woman')
            else:
                my_file = path2+'/images/man.png'
                image = Image.open(my_file)
    ...
    with mygrid[1][0]:
        ...
        with mygrid3[0][0]:
            ...
            if((data.loc[data[str(selected_client)] == "Married", "Client information"] == "Yes").any()):             
                my_file = path2+'/images/rings.png'
                image = Image.open(my_file)
        ...
        with mygrid3[0][1]:
            ...
            my_file = path2+'/images/child.png'
            image = Image.open(my_file)
        ...
        with mygrid3[0][2]:
            ...
            my_file = path2+'/images/working.png'
            image = Image.open(my_file)
    ...
    with mygrid[2][0]:
        ...
        with mygrid4[0][0]:
            ...
            my_file_house = path2+'/images/house.png'
        ...
        with mygrid4[0][1]:
            ...
            my_file_car = path2+'/images/car.png'
