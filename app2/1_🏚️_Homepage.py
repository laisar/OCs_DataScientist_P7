...
#url_current = "https://github.com/laisar/OCs_DataScientist_P7/blob/master/app2/dataset_target_compressed.gz?raw=true"
#df_clients_target = pd.read_csv(url_current, compression='gzip', sep=',')
